...
class Match_model(AbstractModel): 
    ...
    def __init__( 
        ...
        self, match:tuple #  player_1: list, player_2: list 
    ...
    def serialize_object(self, new=True):  ### self est une liste d'objets, il faut boucler dedans : 
        ...
        #         # Get the current_tournament 
            if not new: 
                ...
                print(f'current_tournament MM86 : {current_tournament}') 
    #         # Get the rounds from the current_tournament 
    #         rounds_dicts = current_tournament['rounds'] 
    # #         print(f'type(round_id) MM42 : {type(self.round_id)}')  ### list object has no attr 'round_id' 
    #         print(f'rounds_dicts) MM90 : {rounds_dicts}') 
    #         matches_tuples = rounds_dicts['matches']  
    #         matches_tuples.pop() 
    #         matches_tuples.append(self) 
    #         print(f'matches_tuples) MM94 : {matches_tuples}') 

    #         rounds_dicts['matches'] = matches_tuples 
    #         print(f'rounds_dicts) MM97 : {rounds_dicts}') 
        ...
        #             print(f'current_round MM74 : {current_round}') 
            print(f'current_tournament MM115 : {current_tournament}') 
            tournaments.append(current_tournament) 
            print(f'tournaments MM117 : {tournaments}') 
        else: 
